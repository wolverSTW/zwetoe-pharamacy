...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\xampp\htdocs\zwetoe-pharamacy\backend\public\storage' => 'string',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\xampp\\htdocs\\zwetoe-pharamacy\\backend\\public\\storage','logging.default',
...
'filament.admin.resources.categories.index','filament.admin.resources.categories.create','filament.admin.resources.categories.edit','filament.admin.resources.customers.index','filament.admin.resources.customers.create',
'filament.admin.resources.customers.edit','filament.admin.resources.medicines.index','filament.admin.resources.medicines.create','filament.admin.resources.medicines.edit','filament.admin.resources.orders.index',
'filament.admin.resources.orders.edit','filament.admin.resources.orders.view','filament.admin.resources.users.index','filament.admin.resources.users.create','filament.admin.resources.users.edit',
'sanctum.csrf-cookie','livewire.update','livewire.upload-file',
'livewire.preview-file','storage.local',);
        registerArgumentsSet('views', 
'filament.brand','filament.widgets.welcome-banner','welcome','filament-actions::badge-action','filament-actions::badge-group',
